...
from Zaid import app, BOT_USERNAME, dbb, SUDOERS
import os
import yt_dlp
...
from Zaid.MusicUtilities.helpers.paste import paste
...
from Zaid.MusicUtilities.database.playlist import (get_playlist_count, _get_playlists, get_note_names, get_playlist, save_playlist, delete_playlist)
...
from Zaid.MusicUtilities.helpers.inline import play_keyboard, confirm_keyboard, play_list_keyboard, close_keyboard, confirm_group_keyboard
from Zaid.MusicUtilities.tgcallsrun import (music, convert, download, clear, get, is_empty, put, task_done, smexy)
from Zaid.MusicUtilities.database.queue import (is_active_chat, add_active_chat, remove_active_chat, music_on, is_music_playing, music_off)
...
from Zaid.MusicUtilities.database.assistant import (_get_assistant, get_assistant, save_assistant)
from Zaid.config import DURATION_LIMIT, ASS_ID
from Zaid.MusicUtilities.helpers.decorators import errors
...
from Zaid.MusicUtilities.helpers.inline import (play_keyboard, search_markup, play_markup, playlist_markup)
import requests
from pyrogram.types import (
    CallbackQuery,
    InlineKeyboardButton,
