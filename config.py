...
#BOT_USERNAME = getenv("BOT_USERNAME", "t.me/Sufian_srk_music_bot")
OWNER_ID = getenv("OWNER_ID", "1158888206")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "Sufian_music_1")
#GROUP_SUPPORT = getenv("GROUP_SUPPORT", "t.me/sufian_bot_update")
#UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "t.me/Sufian_bots_update")
